...
class collect_sharppeak(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "collect_sharppeak")
        ...
        self.blocks_file_sink_1 = blocks.file_sink(gr.sizeof_float*1, '/home/lindnera/data/TestSharpWhisperer/software/cw-code/data_sharppeak/sharppeak', False)
